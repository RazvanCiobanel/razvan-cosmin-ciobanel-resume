...
const MyLink = styled.a`
    ...
    &:focus, &:hover, &:visited, &:active, &:Mailto {
        text-decoration: none;
    };
            ...
            <div className="container">
                ...
                <p>
                    <MyLink href="tel:0040767206722"
                        rel="noopener noreferrer"> 0040767206722
                    </MyLink>
                </p> <br />
                <p className="text">
                    <MyLink href="https://www.linkedin.com/in/razvan-cosmin-ciobanel-18237221b"
                        target="_blank"
                        rel="noopener noreferrer">LinkedIn Profile
                    </MyLink>
                </p> <br />
                <p className="text">
